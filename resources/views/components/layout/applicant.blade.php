...
<body x-data="{ openMenu: false }" class="relative font-poppins">
    <!-- This example requires Tailwind CSS v2.0+ -->
    <div x-cloak x-show="openMenu" class="relative z-50" aria-labelledby="slide-over-title" role="dialog"
        aria-modal="true">
                    ...
                    <div x-cloak x-show="openMenu"
                        ...
                        <div class="flex flex-col h-full py-6 overflow-y-scroll bg-white shadow-xl">
                            <div class="px-4 sm:px-6">
                                <div class="flex items-start justify-between sm:px-5">
                                    ...
                                    <div class="flex items-center ml-3 h-7">
                                        <button type="button" x-on:click="openMenu = false"
                            ...
                            <div class="relative flex-1 px-10 mt-10 ">
                                <nav class="justify-center space-y-1 " aria-label="Sidebar">
                                    <a href="#"

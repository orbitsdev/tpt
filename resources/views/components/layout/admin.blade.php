        ...
        -->
          ...
          <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div class="flex items-center flex-shrink-0 px-4">
              <img class="w-auto h-8" src="{{ asset('images/sksu1.png') }}" alt="SKSU">
            </div>
            <nav class="px-2 mt-5 space-y-1">
              ...
              -->
                <svg class="flex-shrink-0 w-6 h-6 mr-4 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none"
      ...
      <div class="flex flex-col flex-1 min-h-0 bg-white border-r border-gray-200">
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
          <div class="flex items-center flex-shrink-0 px-4 space-x-3">
            <img class="w-auto h-8" src="{{ asset('images/sksu1.png') }}" alt="Workflow">
          ...
          <nav class="flex-1 px-2 mt-10 space-y-1 bg-white">
            <a href="{{ route('admin.dashboard') }}"
              ...
              <!-- Heroicon name: outline/users -->
              <svg
                class="{{ Request::routeIs('admin.dashboard') ? 'text-white' : 'text-gray-400 group-hover:text-gray-500' }}flex-shrink-0 w-6 h-6 mr-3 "
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
                  d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            ...
            <a href="{{ route('admin.campuses') }}"
              ...
              <svg
              class="{{ Request::routeIs(['admin.campuses']) ? 'text-white' : 'text-gray-400 group-hover:text-gray-500' }}flex-shrink-0 w-6 h-6 mr-3 "
            ...
            <a href="{{ route('admin.monitoring') }}"
              class="{{ Request::routeIs('admin.monitoring') ? 'bg-theme text-white' : 'hover:bg-gray-50 hover:text-gray-900 text-gray-600' }} flex items-center px-2 py-2 text-sm font-medium  rounded-md  group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor"
                class="{{ Request::routeIs('admin.monitoring') ? 'text-white' : 'text-gray-400 group-hover:text-gray-500' }} flex-shrink-0 w-6 h-6 mr-3">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div x-data="{ open: false }" @click.away="open = false" class="relative ">
                ...
                <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-2" class="origin-top-left absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
            ...
            <form action="{{ route('logout') }}" method="POST" x-data>
              ...
              <a href="{{ route('logout') }}" @click.prevent="$root.submit();"
                class="flex items-center px-2 py-2 text-sm font-medium text-gray-600 rounded-md hover:bg-gray-50 hover:text-gray-900 group">
                <svg xmlns="http://www.w3.org/2000/svg"
                  class="flex-shrink-0 w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-500" viewBox="0 0 20 20"
                  fill="currentColor">
